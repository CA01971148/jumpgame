...
lotteryBox=["normal","slip"]
function createRandomScaffold(level:number,type:scaffoldsType=(lotteryBox[Math.floor(Math.random()*lotteryBox.length)]),width?:number){//足場を作成する関数
    switch (type){
        case "normal":
